  ...
  return (
    <div className="lg:px-0 px-[20px] max-w-[1920px]  mx-auto lg:my-[120px] my-[60px] grid grid-cols-[860px_1fr] gap-[102px] ">
      ...
      <div className="bg-green-300 2xl:max-w-[622px]">
        ...
        <p className="font-roboto pb-[64px] text-text_secondary font-normal text-[16px] sm:text-[18px] leading-[24px] sm:leading-[28px] mb-[27px] tracking-[0%]">
      ...
      <div className="flex gap-[21px] items-start">
        ...
        <button className="mt-[49px] bg-orange-vertical px-[45px] py-[15px] font-roboto font-semibold text-[20px] leading-[30px] tracking-[0%] text-white text-center rounded-[30px]">Discover More</button>
      </div>
    </div>
  );
};
